...
export const SectionFirst = (props) => {
  ...
  return (
    <section className={className}>
      <div className={"section--first__element order border--pink"}>
        ...
        <button className={'button'}>
          <a className={"link"} href="./form.html" id="myHref">
            Złóż zamówienie
          </a>
        </button>
      </div>
      <div className={"section--first__element hero border--pink"} style={style}></div>
    </section>
  )
}
